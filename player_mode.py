...
class PlayerModeManager(object):
    ...
    def enter_mode(self, mode):
        ...
        self.app.message("enter {}".format(mode.name))
        try:
            mode.load()
...
class PlayerModeBase(object):
    def __init__(self, app):
        ...
        self.player.signal_playlist_finished.connect(self.on_playlist_finished)
    ...
    def unload(self):
        self._app.message('exit {} mode'.format(self.name))
        self.player.signal_playlist_finished.disconnect(self.on_playlist_finished)